...
public class OutOfBoundManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            case ArrowType.DynamicCenter:
                outOfBoundR = dynamicCenterPointingIndicatorR;
                outOfBoundL = dynamicCenterPointingIndicatorL;
                break;
            case ArrowType.DynamicCenterReversed:
                outOfBoundR = dynamicCenterReversedPointingIndicatorR;
                outOfBoundL = dynamicCenterReversedPointingIndicatorL;
                break;
            case ArrowType.StaticPointing:
                outOfBoundR = staticArrowIndicatorR;
                outOfBoundL = staticArrowIndicatorL;
                break;
        }
    }
   ...
   public void ChangeIndicator(ArrowType arrowType, string controllerName)
    {
        OutOfBoundIndicator? outOfBoundObject = GetOutOfBoundObject(controllerName);
